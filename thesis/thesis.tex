...
Secondary objective is BCSL...

As it was mentioned in the introduction, the general goal of Comprehensive Modelling Platform is to get as close to the users as possible. This includes the fact that the used formal language should be so-called \emph{human-readable} and simple enough to be understandable beyond computer science community. The above mentioned languages all offer interesting features when it comes to modelling, however none of them focuses on this property except BCSL. (\textbf{later has to be more commented how whole BCS works!!!}).
