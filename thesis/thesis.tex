...
- based on model checking solution (to provide the exact results)

- mention the methods can be used to generate parametrised RE

\subsection{Robustness analysis}

measure required for local robustness (used from Dawe paper) -- easy in probabilistic setting

- since we obtain function, we have global for free
...
\begin{itemize}
\item Doctoral exam and defence of this thesis proposal -- January 2020
