...
There are a few general ways how to analyse rule-based models: (i) \emph{direct} approach operating directly on the level of the model description, (ii) \emph{indirect} approach analyses the transition system generated from the model, and (iii) \emph{semi-direct} approach which employs heuristics or symbolic representation in the process of analysis.
...
The second objective of the thesis is to develop a tool to support modelling and analysis in Biochemical Space Language, which includes the implementation of the proposed analysis methods and further development of the language.
