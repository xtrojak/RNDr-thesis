...
\chapter{State of the Art} \label{chap:state}
 ...
 - add LBS
 - final part - add BCSL, explain more
 - add analysis established for rule-based systems
...
Example of a rule is given in Figure~\ref{bngl-rule}. Software tools have been developed to construct, visualize, simulate, and analyze BNGL models~\cite{wenskovitch2014mosbie,harris2016bionetgen,xu2011rulebender,sneddon2011efficient}.
